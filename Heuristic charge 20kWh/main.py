...
if __name__ == '__main__':
    ...
    x_zo, x_so, p_zo, p_so, r, c = MPC.compute_actions(init_vehs, np.zeros((n, horizon+1, soc)), np.zeros((n, horizon+1, soc, n)), init_reqs)
