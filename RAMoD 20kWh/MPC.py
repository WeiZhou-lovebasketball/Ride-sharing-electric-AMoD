        ...
        for t in range(0, self.horizon + 1):
            for i in range(self.n):
                ...
                for b in range(self.soc):
                    ...
                    if t == 0:
                        mpc.addConstr(veh_idle[i, 0, b] + veh_charging[i, b] == right_sum0 + r[i, i, 0, b] + c[i, 0, b], name = 'Initial vaccant veh conservation')
                    ...
                    # Constraints during the horizon
                        ...
                        mpc.addConstr(veh_idle[i, t, b] + c_sum + r[i, i, t-1, b] + left_sum0 == c[i, t, b] + r[i, i, t, b] + right_sum0,
